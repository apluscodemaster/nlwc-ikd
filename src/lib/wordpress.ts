...
const WP_API_BASE = `${process.env.NEXT_PUBLIC_WORDPRESS_URL || "https://ikdadmin.nlwc.church"}/wp-json/wp/v2`;
...
interface FetchPostsOptions {
  ...
  revalidate?: number; // Data Cache window (seconds); defaults to 300
}
