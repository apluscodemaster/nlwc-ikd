        ...
        {toolbarButtons.map((btn, i) => {
          ...
          return (
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-200/60 transition-colors cursor-pointer"
            >
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {viewMode === "list" ? (
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white font-semibold text-sm shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gray-100 text-gray-700 font-semibold text-sm hover:bg-gray-200 transition-all cursor-pointer"
          >
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-medium transition-all whitespace-nowrap cursor-pointer ${
                active
