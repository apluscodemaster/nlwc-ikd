        ...
        headers: [
          // Content Security Policy to prevent XSS attacks
          {
            ...
            value:
              ...
              "connect-src 'self' *.youtube.com *.google.com *.gstatic.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.firebase.com *.firebaseio.com *.firebaseapp.com *.supabase.co *.cloudinary.com ikdadmin.nlwc.church one.com api.reftagger.com *.reftagger.com *.biblia.com *.faithlife.com challenges.cloudflare.com *.s3.us-east-2.amazonaws.com; " +
